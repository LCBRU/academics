...
class CatalogPublicationsSources(db.Model):
    __table_args__ = (
        UniqueConstraint("catalog_publication_id", "ordinal", name='ux__CatalogPublicationsSources__catalog_publication_id__ordinal'),
        UniqueConstraint("catalog_publication_id", "source_id", name='ux__CatalogPublicationsSources__catalog_publication_id__source_id'),
    )
