...
def upgrade() -> None:
    ...
    op.create_unique_constraint('ux__CatalogPublicationsSources__cat_pub_id__source_id', 'catalog_publications_sources', ['catalog_publication_id', 'source_id'])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('ux__CatalogPublicationsSources__cat_pub_id__source_id', 'catalog_publications_sources', type_='unique')
