...
class AutoFillFoldersViewTester:
    @property
    def endpoint(self):
        return 'ui.auto_fill_folders'


class TestAutoFillFoldersRequiresLogin(AutoFillFoldersViewTester, RequiresLoginTester):
    ...


class TestAutoFillFoldersGet(AutoFillFoldersViewTester, FlaskViewLoggedInTester):
