...
class FolderEmailAuthorsViewBaseTester:
    @property
    def endpoint(self):
        return 'ui.folder_email_authors'
...
class TestFolderEmailAuthorsRequiresLogin(FolderEmailAuthorsViewBaseTester, RequiresLoginTester):
    @property
