...
class FolderSharedUserSearchTester:
    @property
    def endpoint(self):
        return 'ui.folder_shared_user_search'
...
class TestFolderSharedUserSearchRequiresLogin(FolderSharedUserSearchTester, RequiresLoginTester):
    ...


class TestFolderSharedUserSearch(FolderSharedUserSearchTester, IndexTester):
    @pytest.fixture(autouse=True)
